...
function ProjectWrapper(props) {
  ...
  const sortType = (i) => {
    projects
      .sort((a, b) =>
        i === 0 ? b.type.localeCompare(a.type) : a.type.localeCompare(b.type)
      )
      .sort((a, b) => a.status.localeCompare(b.status));
  };
    ...
    projects
      .sort((a, b) =>
        i === 0
          ...
          : a.scopeSort.localeCompare(b.scopeSort)
      )
      .sort((a, b) => a.status.localeCompare(b.status));
  };
      ...
      <section className="project-wrapper">
        ...
        <table className="project-table">
          <th
            ...
            style={{
              backgroundColor:
                sortState === "name" || sortState === "name1"
                  ? "#6AFF19"
                  : "#fff",
            }}
          >
          ...
          <th
            ...
            style={{
              backgroundColor:
                sortState === "year" || sortState === "year1"
                  ? "#6AFF19"
                  : "#fff",
            }}
          >
          ...
          {projects.map(function (project, index) {
            ...
            if (project.status === "wip") {
              return (
                <tr
                  className="project-single-element no-grab"
                  onClick={() => {
                    alert("This project is in progress!");
                  }}
                >
                  <td>
                    {project.title} <i>&#40;work in progress&#41;</i>
                  </td>
                  <td>{project.year}</td>
                </tr>
              );
              ...
              return (
                <tr
                  className="project-single-element music"
                  onClick={() => {
                    goToProject(project);
                  }}
                >
              ...
              return (
                <tr
                  className="project-single-element"
                  onClick={() => {
                    goToProject(project);
                  }}
                >
      ...
      <section className="project-wrapper">
        ...
        <table className="project-table">
          <th
            align="start"
            onClick={() =>
              sortState === "name" ? setSort("name1") : setSort("name")
            }
            style={{
              backgroundColor:
                sortState === "name" || sortState === "name1"
          ...
          <th
            align="start"
            onClick={() =>
              sortState === "scope" ? setSort("scope1") : setSort("scope")
            }
            style={{
              backgroundColor:
                sortState === "scope" || sortState === "scope1"
                  ? "#6AFF19"
                  : "#fff",
            }}
          >
          ...
          <th
            align="start"
            onClick={() =>
              sortState === "type" ? setSort("type1") : setSort("type")
            }
            style={{
              backgroundColor:
                sortState === "type" || sortState === "type1"
                  ? "#6AFF19"
                  : "#fff",
            }}
          >
          ...
          <th
            align="start"
            onClick={() =>
              sortState === "year" ? setSort("year1") : setSort("year")
            }
            style={{
              backgroundColor:
                sortState === "year" || sortState === "year1"
            ...
            if (project.status === "wip") {
              return (
                ...
                >
                  ...
                  <td>
                    {project.scopeSort && project.scopeSort}
                    {!project.scopeSort && project.scope}
                  </td>
                  <td>{project.type}</td>
                  <td>{project.year}</td>
                </tr>
  ...
  return (
    <section className={className} style={leftStyle}>
      ...
      <footer className="footer">
        <a href="mailto:imflatfish01@gmail.com">
          {" "}
          {"imflatfish01@gmail.com".toUpperCase()}{" "}
        </a>
      </footer>
    </section>
  );
        ...
        <section className="about-wrapper about-text-style">
          <div style={mediaWrapper}>
            <img
              style={imageStyle}
              src={
                "https://github.com/soulmilk98/portfolio/blob/main/build/about_img/profile.png?raw=true"
              }
            />
            <br />
            <div style={{ "text-align": "center" }}>
              ...
              <a
                href={
                  "https://github.com/soulmilk98/portfolio/raw/main/build/about_pdf/CV_2024.pdf"
                }
                target="_blank"
                rel="noreferrer"
                className="link"
              ...
              <a
                href={
                  "https://github.com/soulmilk98/portfolio/raw/main/build/about_pdf/Portfolio2024.pdf"
                }
                target="_blank"
                rel="noreferrer"
                className="link"
          ...
          <br />
          <div>
            B.S. KAIST, Mechanical Engineering , Industrial Design (Double
            Major)
            <br />
            M.S. KAIST, Industrial Design,{" "}
            <a
              href={"https://reflect9.github.io/ael/"}
              target="_blank"
              rel="noreferrer"
              className="link"
            >
          ...
          <b>CONTACT</b>
          <AboutLink
            href={"mailto:imflatfish01@gmail.com"}
            text={"imflatfish01@gmail.com".toUpperCase()}
          />
          <br />
          <AboutLink
            href={"https://www.instagram.com/hogam_im_/"}
            text={"IG. @윤유상"}
          />
          <AboutLink
            href={"https://www.instagram.com/flatfish01/"}
            text={"IG. @넙치"}
          />
          <br />
          <AboutLink
            href={"https://www.youtube.com/@hogam_im_"}
            text={"Youtube. @윤유상(Project)"}
          />
          <AboutLink
            href={"https://www.youtube.com/@iamflatfish"}
            text={"Youtube. @넙치(Music)"}
          />
          <br />
        ...
        <header className="header">
          ...
          >
            {(value.selectedProject.status == "music" && "Music") ||
              value.selectedProject.scopeSort}
          </Link>
          <Link
            className="header-button"
            onClick={() => {
...
function MobileSection(props) {
  ...
  let introduction_kr = "안녕하세요 넙치입니다.";
  let school =
    "B.S. Mechanical Engineering , Industrial Design(Double Major), KAIST / M.S. Industrial Design, KAIST";
